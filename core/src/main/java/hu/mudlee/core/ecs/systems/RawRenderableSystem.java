...
public class RawRenderableSystem extends IteratingSystem {
  private final ComponentMapper<VertexArrayComponent> vaoMapper = ComponentMapper.getFor(VertexArrayComponent.class);
  private final ComponentMapper<ShaderComponent> shaderMapper = ComponentMapper.getFor(ShaderComponent.class);
  private final ComponentMapper<RawRenderSettingsComponent> settingsMapper = ComponentMapper.getFor(RawRenderSettingsComponent.class);
