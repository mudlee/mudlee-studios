...
public class TextureLoader {
	private final static Logger LOG = LoggerFactory.getLogger(TextureLoader.class);
	...
	private static TextureData loadFromByteBuffer(ByteBuffer byteBuffer, MemoryStack stack, String path) {
